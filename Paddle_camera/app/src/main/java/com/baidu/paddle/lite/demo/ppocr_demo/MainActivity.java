...
public class MainActivity extends Activity implements View.OnClickListener, CameraSurfaceView.OnTextureChangedListener {
    ...
    protected String detModelPath = "ch_PP-OCRv3_det_slim_infer.nb";
    protected String recModelPath = "ch_ppocr_mobile_v2.0_rec_opt.nb";
    ...
    public boolean onTextureChanged(int inTextureId, int outTextureId, int textureWidth, int textureHeight) {
        ...
        if (lastFrameIndex % 3 == 0)
            modified = predictor.process(inTextureId, outTextureId, textureWidth, textureHeight, savedImagePath, 0);
        else
            modified = predictor.process(inTextureId, outTextureId, textureWidth, textureHeight, savedImagePath, 1);
        ...
        lastFrameIndex++;
        Log.i("FRAME", "Last frame index: " + lastFrameIndex);
